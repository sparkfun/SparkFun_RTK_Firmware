...
void w5500EnableSocketInterrupts()
{
  ...
  w5500write(SPI, pin_Ethernet_CS, w5500SIMR, w5500CommonRegister, (uint8_t *)&w5500SIMR_EnableAll, 1); //Enable the socket interrupt on all eight sockets
}

void w5500EnableSocketInterrupt(uint8_t sockIndex)
{
  w5500write(SPI, pin_Ethernet_CS, w5500SnIMR, w5500SocketRegisters[sockIndex], (uint8_t *)&w5500SnIMR_RECV, 1); //Enable the RECV interrupt for sockIndex only
