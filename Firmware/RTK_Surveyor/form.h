                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="form-group row box-margin20">
                                        <label for="UBX_NAV_GEOFENCE"
                                            class="col-sm-3 col-form-label">NAV_GEOFENCE</label>
                                        <div class="col-sm-8"><input type="number" class="form-control"
                                    ...
                                    <div class="form-group row box-margin20">
                                        <label for="UBX_NAV_HPPOSECEF"
                                            class="col-sm-3 col-form-label">NAV_HPPOSECEF</label>
                                        <div class="col-sm-8"><input type="number" class="form-control"
                                    ...
                                    <div class="form-group row box-margin20">
                                        <label for="UBX_NAV_HPPOSLLH"
                                            class="col-sm-3 col-form-label">NAV_HPPOSLLH</label>
                                        <div class="col-sm-8"><input type="number" class="form-control"
                                    ...
                                    <div class="form-group row box-margin20">
                                        <label for="UBX_NAV_RELPOSNED"
                                            class="col-sm-3 col-form-label">NAV_RELPOSNED</label>
                                        <div class="col-sm-8"><input type="number" class="form-control"
                    ...
                    <div class="card card-body">
                        ...
                        <div class="form-group row">
                            <label for="observationPositionAccuracy"
                                class="box-margin20 col-sm-3 col-form-label">Required Mean 3D Standard Deviation
                                (m)</label>
                            <div class="col-sm-8">
                        ...
                        <div>
                            ...
                            <label for="baseTypeFixed">Fixed</label><br>
                        </div>
                        ...
                        <div>
                            <input type="radio" id="fixedBaseCoordinateTypeGeo" name="positionType" value="1"
                                class="form-radio box-margin20">
                            <label for="fixedBaseCoordinateTypeGeo">Geographic</label><br>
                        </div>
