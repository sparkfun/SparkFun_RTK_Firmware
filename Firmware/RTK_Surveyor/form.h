        ...
        <div style="margin-top:20px;">
                        ...
                        <div id="uploadNewFirmwareDiv" class="mb-2">
                            ...
                            <div class="form-check">
                                <label class="btn btn-primary">
                                    <input type="file" name="binfile" id="submitFirmwareFile"
                                        onchange="firmwareUploadWait()" />
                                    Upload BIN
                                </label>
            ...
            <div class="collapse" id="collapseFileManager">
                <div class="card card-body">
                    ...
                    <div align="center">
                            SD Size: <p id="sdSize" style="display:inline;">0 MB</p> / Free: <p id="sdFreeSpace" style="display:inline;">0 MB</p>
                    </div>
