    ...
    <div class="container" style="margin-top:20px;max-width:600px;" id="mainPage">
        ...
        <div class="col-sm-12 mt-3">
            <div align="center" class="small">
                ...
                <span id="zedFirmwareVersion" style="display:inline;">ZED-F9P Firmware: v0.0</span>
            </div>
        </div>
        ...
        <div style="margin-top:20px;">
            <form>
                ...
                <!-- --------- Sensor Config --------- -->
                <div class="d-grid gap-2">
                    <button class="btn btn-primary mt-3 toggle-btn" id="sensorConfig" type="button"
                        data-toggle="collapse" data-target="#collapseSensorConfig" aria-expanded="false"
                        aria-controls="collapseSensorConfig">
                ...
                <div class="row">
                    ...
                    <div align="center" class="col-sm-5 col-12">
                        <button type="button" id="exitBtn" class="btn btn-outline-secondary" onclick="exitConfig()">Exit
                            to Rover
                            Mode <span class="icon-remove text-secondary ms-1"></span></button>
